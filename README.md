...
- Undo/redo, save/load circuits (`.esim` JSON format)
...
- Nonlinear device support (iterative convergence for diodes)
...
| Semiconductors | Diode, Zener Diode, Lamp |
...
│   │   └── components/     # 15 component implementations
│   ├── simulation/          # MNA solver, analysis configs, results
...
Test suites include voltage dividers, RC/RL/RLC filters, bridge rectifiers, diode clippers, zener regulators, and more.
