...
GXORGate::GXORGate(XORGate* gate)
...
void GXORGate::drawSymbol(QPainter* painter)
{
    ...
    QPainterPath path;
    path.moveTo(-15, -18);
    path.quadTo(15, -18, 18, 0);
    path.quadTo(15, 18, -15, 18);
    path.quadTo(-5, 0, -15, -18);
    painter->drawPath(path);

    // Extra input curve (XOR distinctive mark)
    QPainterPath xorCurve;
    xorCurve.moveTo(-19, -18);
    xorCurve.quadTo(-9, 0, -19, 18);
